  ...
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        ...
        <sidebar-link to="/category" :name="$t('sidebar.category')" icon="tim-icons icon-align-center"/>
        <sidebar-link to="/product" :name="$t('sidebar.product')" icon="tim-icons icon-align-center"/>
